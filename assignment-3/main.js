...
function drawBarraEsquerda() {
    ...
    console.log(verticesBarraEsquerda)
    gl.drawArrays(
        gl.TRIANGLES,
        0,
...
function atualizaAnimacao() {
    ...
    console.log(txBola < 0.8)
    if (txBola < -0.8 && (tyBola > tyBE - 0.2 && tyBola < tyBE + 0.2)) {
        console.log("HERE", tyBola, tyBE)
        txBola_offset = -txBola_offset;
        tyBola_offset = -tyBola_offset;
        txBola += txBola_offset;
        tyBola += tyBola_offset;

    } else if (txBola > 0.8 && (tyBola > tyBD - 0.2 && tyBola < tyBD + 0.2)) {
        console.log("HERE", tyBola, tyBD)
        txBola_offset = -txBola_offset;
        tyBola_offset = -tyBola_offset;
        txBola += txBola_offset;
        tyBola += tyBola_offset;
    ...
    if (INCREMENT_ONE !== 0) {
        if (!((tyBE > 0.8 && INCREMENT_ONE > 0) || (tyBE < -0.8 && INCREMENT_ONE < 0))) {
            tyBE += tyBE_offset * INCREMENT_ONE
        }
    }
    ...
    if (INCREMENT_TWO !== 0) {
        if (!((tyBD > 0.8 && INCREMENT_TWO > 0) || (tyBD < -0.8 && INCREMENT_TWO < 0))) {
            tyBD += tyBD_offset * INCREMENT_TWO
        }
    }
